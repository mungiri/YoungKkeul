...
function buildPrompt(d) {
  ...
  return [
    '너는 따뜻하고 현실적인 동네 안내자야. 아래 동네의 상권 데이터를 보고, 결혼을 앞둔 20대 예비 신혼부부가 "여기서 신혼집을 차려도 좋을까?"를 판단하는 데 도움이 되도록 해석해줘.',
    '',
    '[동네 데이터]',
    lines.join('\n'),
    '',
    '[작성 규칙]',
    '- 한국어로, 20대에게 친근하고 다정한 말투. 전문용어는 풀어서 설명.',
    '- 4~6문장. 첫 문장은 이 동네가 신혼부부에게 한마디로 어떤 동네인지 요약.',
    '- 다음 관점을 자연스럽게 녹여줘: ①신혼부부 거주 추천 여부와 이유 ②동네 분위기(차분한지/번화한지, 밤에도 활기찬지) ③체감 치안·안전(데이터에 범죄 통계는 없으니, 유흥·술집 비중이 높으면 밤에 다소 번잡/소란할 수 있고, 편의·의료·학원·카페 등 생활시설이 고루 있으면 정주 여건이 안정적이라는 식으로 업종 구성에서 \'추정\'해 설명. 단정 짓지 말고 "~한 편이에요"처럼 부드럽게) ④장보기·병원·카페 같은 신혼 생활 편의.',
    '- 마지막에 이 동네를 고를 때 참고할 점이나 한 가지 주의할 점을 짚어줘.',
    '- 숫자를 그대로 나열하지 말고 "카페가 유난히 많은 편" 처럼 의미로 풀어줘.',
    '- 치안 통계가 직접 데이터에 없다는 점은 "정확한 범죄 통계는 따로 확인해보시는 게 좋아요" 정도로 한 번만 짧게 언급(과하게 반복 금지).',
